...
class ContactGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Contact entity")
        ...
        .repeat(2) {
            ...
            .post("/api/contacts")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "firstName":"SAMPLE_TEXT", "lastName":"SAMPLE_TEXT", "nickName":"SAMPLE_TEXT", "company":"SAMPLE_TEXT", "jobTitle":"SAMPLE_TEXT", "birthdate":"2020-01-01T00:00:00.000Z", "website":"SAMPLE_TEXT", "photo":null, "notes":"SAMPLE_TEXT"}""")).asJSON
            .check(status.is(201))
